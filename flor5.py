...
flower_turtle.speed(0)  # Máxima velocidad
flower_turtle.width(2)

# Aceleramos el proceso con tracer
screen.tracer(0)  # Desactivar el auto-dibujo
flower_turtle.penup()
...
def draw_flower():
    ...
    for i in range(195):
        ...
        flower_turtle.circle(i * 0.3, 120)
        h += 0.006
        screen.update()  # Actualizar el dibujo
...
def main():
    ...
    # Pausa de 2 segundos antes de empezar a dibujar la flor
    time.sleep(2)
